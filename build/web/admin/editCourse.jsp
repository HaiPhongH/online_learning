    ...
    <body>
        ...
        <div class="admin_options">
            <div class="detail_options">
                <div id="edit_course_contents">
                    <p>${notification}</p>
                    <form method="post" action="" id="change_form">
                        <input type="hidden" name="action" value="editCourse" id="change_value">
                        Course Name: <input type="text" value="${course.getCourseName()}" required name="editName" id="name_change">
                        Price: <input type="text" value="${course.getPrice()}" required name="editPrice">
                        Course Title: <input type="text" value="${course.getCourseTitle()}" required name="editTitle">
                        Date: <input type="text" value="${course.getDate()}" required name="editDate">
                        Author: <input type="text" value="${course.getAuthor()}" required name="editAuthor">
                        List course: <input type="text" value="${course.getListCourse()}" required name="editList">
                        Image: <input type="text" placeholder="${course.getImage()}" required name="editImage">
                        <input type="submit" value="Edit Course" name="editButton" id="btn_change_value">
                    </form>
                </div>
            </div>
        </div>
