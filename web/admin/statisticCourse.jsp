        ...
        <div class="admin_options">
            ...
            <div id="content_course">
                <table class="table_statistic">
                    <tr class="row">
                        <th class="sub_row">Course Name</th>
                        <th class="sub_row">Course Date</th>
                        <th class="sub_row">Course Title</th>
                    </tr>
                    <%
                        for(Course course:listCourse){
                    %>
                    <tr class="row">
                        <td class="sub_row"><%=course.getCourseName()%></td>
                        <td class="sub_row"><%=course.getDate()%></td>
                        <td class="sub_row"><%=course.getCourseTitle()%></td>
                    </tr>
                    <%
                        }
                    %>
                </table>
                <p>NUMBER OF ADDED COURSE IN THAT TIME: ${countCourse}</p>
            </div>
        </div>
        <!--Footer-->
        <div class="footer">
